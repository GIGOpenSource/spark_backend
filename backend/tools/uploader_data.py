...
region = getEnvConfig('TENCENT_COS_REGION', )
bucket_name = getEnvConfig('TENCENT_COS_BUCKET')
                        ...
                        'schema': {
                            ...
                            'properties': {
                                ...
                                'data': {
                                    'type': 'object',
                                    'properties': {
                                        'url': {'type': 'string', 'example': 'https://build-1438174850.cos.ap-bangkok.myqcloud.com/goods/ccb0b889e8394032846125b2309df6cc.jpg'},
    ...
    def post(self, request):
        try:
            ...
            response = cos_client.put_object(
                ...
                Body=file_content,
                Key=full_file_name,
                StorageClass='STANDARD',  # 使用多可用区存储类
                EnableMD5=False
            )
            if response['ETag']:
                # 生成文件访问URL
