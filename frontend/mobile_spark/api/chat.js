...
export function apiSearchGifs(q, limit = 20) {
	return getRequest('/chat/gifs/search/', { q, limit }, { showLoading: false })
}

export function apiCallToken(conversationId) {
	return postRequest('/chat/call/token/', { conversation_id: conversationId }, { showLoading: false })
}

export function apiCallHangup(conversationId) {
	return postRequest('/chat/call/hangup/', { conversation_id: conversationId }, { showLoading: false, errorOutput: false })
}
